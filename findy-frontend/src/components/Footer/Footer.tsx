        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li><a href="/" className="footer-link">뉴스 검색</a></li>
              <li><a href="/search" className="footer-link">카테고리별 뉴스</a></li>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#" className="footer-link">개선 제안</a></li>
              <li><a href="#" className="footer-link">버그 신고</a></li>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#" className="footer-link">저작권 정책</a></li>
              <li><a href="#" className="footer-link">뉴스 제공업체</a></li>
              <li><a href="#" className="footer-link">광고 정책</a></li>
            </ul>
          </div>
        </div>
